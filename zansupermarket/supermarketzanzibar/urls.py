...
urlpatterns = [
    ...
    path('auth/google/verify-otp/', CustomerGoogleVerifyOTPView.as_view(), name='customer_google_verify_otp'),
    path('auth/google/resend-otp/', CustomerGoogleResendOTPView.as_view(), name='customer_google_resend_otp'),
