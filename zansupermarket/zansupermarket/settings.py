...
SUPER_SYSTEM_CONTROL_ENABLED = env_bool("SUPER_SYSTEM_CONTROL_ENABLED", False)
SUPER_SYSTEM_SERVICE_ID = os.getenv("SUPER_SYSTEM_SERVICE_ID", "").strip()
SUPER_SYSTEM_LICENSE_KEY = os.getenv("SUPER_SYSTEM_LICENSE_KEY", "").strip()
SUPER_SYSTEM_API_KEY = os.getenv("SUPER_SYSTEM_API_KEY", "").strip()
SUPER_SYSTEM_API_SECRET = os.getenv("SUPER_SYSTEM_API_SECRET", "").strip()
SUPER_SYSTEM_API_URL = os.getenv("SUPER_SYSTEM_API_URL", "").strip()
SUPER_SYSTEM_LICENSE_VALIDATE_URL = os.getenv("SUPER_SYSTEM_LICENSE_VALIDATE_URL", "").strip()
SUPER_SYSTEM_SUBSCRIPTION_STATUS_URL = os.getenv("SUPER_SYSTEM_SUBSCRIPTION_STATUS_URL", "").strip()
SUPER_SYSTEM_HEARTBEAT_URL = os.getenv("SUPER_SYSTEM_HEARTBEAT_URL", "").strip()
SUPER_SYSTEM_CONTROL_CACHE_SECONDS = int(os.getenv("SUPER_SYSTEM_CONTROL_CACHE_SECONDS", "300"))
